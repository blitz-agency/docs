...
BlitzAPI is a **flat monthly subscription — no credits, no per-request fees**. Choose the plan that unlocks the APIs you need.
...
<Card title="See full plan comparison" icon="receipt" href="/guide/concepts/pricing-unlimited">
  Detailed feature matrix, use case guide, and free trial credits.
</Card>
