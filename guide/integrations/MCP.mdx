...
<Tabs>
  <Tab title="Claude (claude.ai)">
    ...
    3. Select **"Add integration"** and search for **"Blitz API"**.
    4. The connector will be available in your conversation.
...
<AccordionGroup>
  ...
  <Accordion title="Find people matching your ICP">
    ```
    Using Blitz API People Search, find VPs of Sales at SaaS companies with 51-200 employees in the US. Show me the full request and how to paginate.
    ```
  </Accordion>
</AccordionGroup>
